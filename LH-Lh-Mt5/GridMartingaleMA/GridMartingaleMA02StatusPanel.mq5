//+------------------------------------------------------------------+
//| GridMartingaleMA02StatusPanel.mq5                                |
//| Reads Python-exported state, draws panel and TP lines in MT5.    |
//+------------------------------------------------------------------+
#property strict
#property version   "1.00"
#property description "GridMartingaleMA02 MT5 panel / TP lines / close buttons"

#include <Trade/Trade.mqh>

input ulong  InpMagic            = 2025892;
input string InpStatusExportFolder = "GridMartingaleMA02"; // 与 Python bridge 的 strategy_name 一致；利滚利选 CompoundMartin
...
void PutDefaultStatus()
  {
   ResetPairs();
   PutPair("strategy","GridMartingaleMA02");
